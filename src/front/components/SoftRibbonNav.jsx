...
export default function SoftRibbonNav() {
  ...
  return (
    <div className="soft-ribbon-wrapper">
      <style>{`
        .soft-ribbon-wrapper{ position:sticky; top:12px; z-index:1040; }
        .soft-ribbon{
          max-width:1180px; margin:0 auto;
          display:flex; align-items:center; gap:18px;
          padding:12px 16px 12px 18px; border-radius:28px;
          background: linear-gradient(90deg, rgba(255,255,255,.92), rgba(255,255,255,.86));
          border:1px solid rgba(203,12,159,.12); backdrop-filter: blur(8px);
        ...
        .soft-dd > summary{
          ...
          padding:8px 12px; font-weight:600; color:#20314d; transition:.15s ease;
        }
        ...
        .soft-panel{
          ...
          background:#fff; border-radius:14px; border:1px solid rgba(15,23,42,.06);
          box-shadow:0 18px 48px rgba(15,23,42,.18);
          padding:10px; display:grid; gap:6px; z-index:10;
        }
        .soft-link{
        ...
        /* Variante CTA para logout */
        .soft-cta-danger{
          background: linear-gradient(310deg, #ef4444, #f97316);
